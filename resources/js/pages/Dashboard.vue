            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
                ...
                <div v-else class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 px-5 py-3">
                            <RouterLink to="/posts" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                View all posts
                            </RouterLink>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 px-5 py-3">
                            <RouterLink to="/approvals" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                Review pending
                            </RouterLink>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 px-5 py-3">
                            <RouterLink to="/posts?status=approved" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                View approved
                            </RouterLink>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 px-5 py-3">
                            <RouterLink to="/brands" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                Manage brands
                            </RouterLink>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Create New Post</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400 truncate">Draft a new social media post</p>
                            </div>
                        </RouterLink>
                        ...
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 truncate">Add images and videos</p>
                            </div>
                        </RouterLink>
                        ...
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Manage Brands</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400 truncate">Add or edit brand profiles</p>
                            </div>
                        </RouterLink>
                    </div>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-4 bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
                        ...
                        <div v-else-if="recentPosts.length === 0" class="p-6 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <div class="px-4 py-4 sm:px-6">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="ml-2 flex-shrink-0 flex items-center gap-3">
                                                ...
                                                <span class="text-sm text-gray-500 dark:text-gray-400">{{ formatDate(post.updated_at) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </RouterLink>
                        ...
                        <div v-if="recentPosts.length > 0" class="bg-gray-50 dark:bg-gray-700 px-4 py-3 text-right">
                            <RouterLink to="/posts" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                View all posts &rarr;
                            </RouterLink>
                        </div>
