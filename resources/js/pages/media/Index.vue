        ...
        <div class="py-6">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
                ...
                <div v-if="loading" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    <div v-for="i in 12" :key="i" class="aspect-square bg-gray-200 rounded-lg animate-pulse"></div>
                </div>

                <!-- Empty State -->
                <div v-else-if="media.length === 0" class="bg-white shadow rounded-lg p-12 text-center">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            <label for="file-upload" class="cursor-pointer">
                                ...
                                <p class="mt-1 text-xs text-gray-500">PNG, JPG, MP4 up to 100MB</p>
                            </label>
                        </div>

                        <!-- Selected files list -->
                        <div v-if="uploadForm.files.length > 0" class="space-y-2">
                            <p class="text-sm font-medium text-gray-700">Selected files ({{ uploadForm.files.length }})</p>
