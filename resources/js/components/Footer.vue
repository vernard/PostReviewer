        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    <h3 class="text-xl font-bold text-white mb-4">Post Reviewer</h3>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="/#demo" class="hover:text-white transition-colors">Try Demo</a>
                        </li>
                        <li>
                            <RouterLink to="/register" class="hover:text-white transition-colors">Get Started</RouterLink>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="mailto:support@postreviewer.com" class="hover:text-white transition-colors">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
